# Buckling of unstiffened shells

## Linear buckling of cylindrical shells

# Buckling and post-buckling of cylindrical shells under compression and torsion
...
The integration of the Donnell shell theory with the Galerkin method and arc-length continuation provides a robust framework for exploring shell instabilities. These insights are critical for designing next-generation foldable structures and origami-inspired systems where buckling is a functional feature rather than a failure mode.
